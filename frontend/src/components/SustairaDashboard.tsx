...
// Data for Sustaira Civic Score (Jan to Sept)
const scoreData = [
...
// Data for Carbon Offsets / Incident frequency (2026)
const timelineData = [
...
// Donut data for Demographics / Ward Breakdown
const raceData = [
...
export const SustairaDashboard: React.FC<SustairaDashboardProps> = ({
  ...
  return (
    <div className="dashboard-grid">
      ...
      {/* 3. Carbon & Incident Offsets Timeline */}
      ...
      {/* 4. DEI & City Equity Score (Radial Arc Gauge Visual) */}
      <div className="dash-card" style={{ gridColumn: 'span 4' }}>
        <div className="dash-card-header">
        ...
        <div className="dei-radial-container">
          <svg width="150" height="150" viewBox="0 0 160 160">
            ...
            {/* Inner Ring - Compensation / Resource 61% */}
      ...
      {/* 5. Headcount / Participation Gradient Stack */}
      ...
      {/* 7. CO2 Cloud Offset Visual Card */}
      <div className="dash-card cloud-meter-card" style={{ gridColumn: 'span 3' }}>
        ...
        <div className="cloud-visual-box">
          ...
          <div className="cloud-overlay-text">40 <span style={{ fontSize: '0.8rem' }}>MTCO₂e</span></div>
        </div>
        <div style={{ fontSize: '0.75rem', color: '#64748b' }}>Current City Target Milestone</div>
      </div>

      {/* 8. KPI Projects & Initiatives */}
        ...
        <div className="kpi-projects-list">
          ...
          <div className="kpi-project-item">
            <div className="kpi-title-row">
              ...
              <span className="text-emerald-600 font-bold">59%</span>
            </div>
      ...
      {/* 10. Detailed Environmental & Fire Incident Log */}
